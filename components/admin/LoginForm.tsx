        ...
        <div className="relative z-10 w-full max-w-md">
          ...
          <div className="bg-neutral-950 border border-neutral-800 rounded-2xl p-8 flex flex-col gap-5 backdrop-blur-sm">
            ...
            <button
              ...
              disabled={submitting}
              className="w-full py-3 rounded-full border border-white/20 text-white text-sm font-mono tracking-widest uppercase hover:bg-white/10 transition-colors disabled:opacity-50 flex items-center justify-center gap-3"
            >
              {!submitting && (
